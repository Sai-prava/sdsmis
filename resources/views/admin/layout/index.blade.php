                    ...
                    <ul class="nav nav-sidebar" data-nav-type="accordion">
                        ...
                        <li class="nav-item nav-item-submenu {{ Request::is('admin/user*') ? 'nav-item-open' : '' }}">
                            ...
                            <ul class="nav nav-group-sub" data-submenu-title="Layouts"
                                style="{{ Request::is('admin/user*') ? 'display:block' : '' }}">
                                <li class="nav-item"><a href="{{ route('admin.user.admin') }}"
                                        class="nav-link {{ Request::is('admin/user/admin') || Request::is('admin/user/create_admin') ? 'active' : '' }}">Admin</a>
                                </li>
                                <li class="nav-item"><a href="{{ route('admin.user.project_manager') }}"
                                        class="nav-link {{ Request::is('admin/user/project_manager') || Request::is('admin/user/create_project_manager') ? 'active' : '' }}">Project
                                        Manager</a></li>
                                <li class="nav-item"><a href="{{ route('admin.user.executive') }}"
                                        class="nav-link {{ Request::is('admin/user/executive') || Request::is('admin/user/create_executive') ? 'active' : '' }}">Executive</a>
                                </li>
                                <li class="nav-item"><a href="{{ route('admin.user.field_staff') }}"
                                        class="nav-link {{ Request::is('admin/user/field_staff') || Request::is('admin/user/create_field_staff') ? 'active' : '' }}">Field
                                        Staff</a></li>
                                <li class="nav-item"><a href="{{ route('admin.user.crp') }}"
                                        class="nav-link {{ Request::is('admin/user/crp') || Request::is('admin/user/create_crp') ? 'active' : '' }}">CRP</a>
                                </li>
                            </ul>
                        </li>
                        <li
                            class="nav-item nav-item-submenu {{ Request::is('admin/project*') || Request::is('admin/project_user*') || Request::is('admin/major_delivery*') ? 'nav-item-open' : '' }}">
                            <a href="#" class="nav-link"><i class="icon-home4"></i> <span>Projects</span></a>

                            <ul class="nav nav-group-sub" data-submenu-title="Layouts"
                                style="{{ Request::is('admin/project*') || Request::is('admin/project_user*') || Request::is('admin/major_delivery*') ? 'display:block' : '' }}">
                                <li class="nav-item"><a href="{{ route('admin.project.index') }}"
                                        class="nav-link {{ Request::is('admin/project') || Request::is('admin/project/*') ? 'active' : '' }}">Project
                                        Master</a></li>
                                <li class="nav-item"><a href="{{ route('admin.project_user.index') }}"
                                        class="nav-link {{ Request::is('admin/project_user') || Request::is('admin/project_user/*') ? 'active' : '' }}">Project
                                        Team</a></li>
                                <li class="nav-item"><a href="{{ route('admin.major_delivery.index') }}"
                                        class="nav-link {{ Request::is('admin/major_delivery') || Request::is('admin/major_delivery/*') ? 'active' : '' }}">Major
                                        Delivery</a></li>
                            </ul>
                        </li>
                        <li
                            class="nav-item nav-item-submenu {{ Request::is('admin/farming_profile*') || Request::is('admin/pond_preparation*') || Request::is('admin/monthly_farming_report*') ? 'nav-item-open' : '' }}">
                            <a href="#" class="nav-link"><i class="icon-home4"></i> <span>Fishery
                                    Project</span></a>

                            <ul class="nav nav-group-sub" data-submenu-title="Layouts"
                                style="{{ Request::is('admin/farming_profile*') || Request::is('admin/pond_preparation*') || Request::is('admin/monthly_farming_report*') ? 'display:block' : '' }}">
                                <li class="nav-item"><a href="{{ route('admin.farming_profile.index') }}"
                                        class="nav-link {{ Request::is('admin/farming_profile') || Request::is('admin/farming_profile/*') ? 'active' : '' }}">Farming
                                        Profile</a></li>
                                ...
                                <li class="nav-item"><a href="{{ route('admin.monthly_farming_report.index') }}"
                                        class="nav-link {{ Request::is('admin/monthly_farming_report') || Request::is('admin/monthly_farming_report/*') ? 'active' : '' }}">Monthly
                                        Farming Report</a></li>
                            </ul>
                        </li>
                        <li
                            class="nav-item nav-item-submenu {{ Request::is('admin/training_report*') ? 'nav-item-open' : '' }}">
                            <a href="#" class="nav-link"><i class="icon-home4"></i> <span>Report</span></a>

                            <ul class="nav nav-group-sub" data-submenu-title="Layouts"
                                style="{{ Request::is('admin/training_report*') ? 'display:block' : '' }}">
                                <li class="nav-item"><a href="{{ route('admin.training_report.index') }}"
                                        class="nav-link {{ Request::is('admin/training_report') || Request::is('admin/training_report/*') ? 'active' : '' }}">Training
                                        Report</a></li>
                            </ul>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.respondent_master.index') }}"
                                class="nav-link {{ Request::is('admin/respondent_master') ? 'active' : '' }}">
                                <i class="icon-home4"></i>
                                <span>Respondent Master Form</span>
                            </a>
                        </li>
                        <li
                            class="nav-item nav-item-submenu {{ Request::is('admin/country*') || Request::is('admin/state*') || Request::is('admin/city*') || Request::is('admin/district*') || Request::is('admin/police_station*') || Request::is('admin/block*') || Request::is('admin/gram_panchyat*') || Request::is('admin/village*') ? 'nav-item-open' : '' }}">
                            <a href="#" class="nav-link"><i class="icon-map"></i> <span>Locations</span></a>

                            <ul class="nav nav-group-sub" data-submenu-title="Layouts"
                                style="{{ Request::is('admin/country*') || Request::is('admin/state*') || Request::is('admin/city*') || Request::is('admin/village*') || Request::is('admin/district*') || Request::is('admin/police_station*') || Request::is('admin/block*') || Request::is('admin/gram_panchyat*') ? 'display:block' : '' }}">
                                <li class="nav-item"><a href="{{ route('admin.location.report') }}"
                                        class="nav-link {{ Request::is('admin/location.report') ? 'active' : '' }}">Report</a>
                                </li>
                                <li class="nav-item"><a href="{{ route('admin.country.index') }}"
                                ...
                                <li class="nav-item"><a href="{{ route('admin.police_station.index') }}"
                                        class="nav-link {{ Request::is('admin/police_station') ? 'active' : '' }}">Police
                                        Station</a></li>
                                <li class="nav-item"><a href="{{ route('admin.district.index') }}"
