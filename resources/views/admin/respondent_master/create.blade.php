    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.respondent_master.store') }}" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select name="block_id" id="block_id" class="form-control select-search" data-fouc
                                    required>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select name="village_id" id="village_id" class="form-control select-search" data-fouc
                                    required>
                            ...
                            <div class="form-group col-md-4">
                                <label>Age</label>
                                <input name="age" type="number" step="0.01" class="form-control"
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input name="number_family_member" type="number" step="0.01" class="form-control"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#village_id').change(function() {
                ...
                // Fetch PGs
                $.ajax({
                    url: "{{ route('admin.monthly_farming_report.get_pgs') }}",
                    method: 'post',
                    data: {
                        village_id: village_id
                    },
                    ...
                    success: function(response) {
                        $('#pg_id').empty();
                        $('#pg_id').append('<option disabled selected>Select PG</option>');
                        response.pgs.forEach(function(pg) {
                            $('#pg_id').append('<option value="' + pg.id + '">' + pg
                                .name + '</option>');
                        });
                    }
                });
