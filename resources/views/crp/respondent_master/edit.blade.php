                    ...
                    <form action="{{ route('crp.respondent_master.update', $respondent_master->id) }}" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select id="district_id" name="district_id" class="form-control select-search" data-fouc required disabled>
                            ...
                            <div class="form-group col-md-4">
                                <label>Block</label>
                                <select id="block_id" name="block_id" class="form-control select-search" data-fouc required disabled>
                            ...
                            <div class="form-group col-md-4">
                                <label>Village</label>
                                <select id="village_id" name="village_id" class="form-control select-search" data-fouc required disabled>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select id="shg_id" name="shg_id" class="form-control select-search" data-fouc>
                                    ...
                                    @foreach (App\Models\SHG::where('village_id', $respondent_master->village_id)->get() as $shg)
                                        <option value="{{ $shg->id }}" {{ $respondent_master->shg_id == $shg->id ? 'selected' : '' }}>
                                            {{ $shg->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select id="pg_id" name="pg_id" class="form-control select-search" data-fouc>
                                    ...
                                    @foreach (App\Models\PG::where('village_id', $respondent_master->village_id)->get() as $pg)
                                        <option value="{{ $pg->id }}" {{ $respondent_master->pg_id == $pg->id ? 'selected' : '' }}>
                                            {{ $pg->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select name="gender" class="form-control select-search" data-fouc required>
                                    ...
                                    <option {{ $respondent_master->gender == 'Male' ? 'selected' : '' }} value="Male">Male
                                    </option>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select name="education" class="form-control select-search" data-fouc required>
                                    ...
                                    <option {{ $respondent_master->education == 'Primary' ? 'selected' : '' }} value="Primary">
                                        Primary</option>
                                    <option {{ $respondent_master->education == 'HSLC' ? 'selected' : '' }} value="HSLC">HSLC
                                    </option>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select name="religion" class="form-control select-search" data-fouc required>
                                    ...
                                    <option {{ $respondent_master->religion == 'Hindu' ? 'selected' : '' }} value="Hindu">
                                        Hindu</option>
                                    <option {{ $respondent_master->religion == 'Muslim' ? 'selected' : '' }} value="Muslim">
                                        Muslim</option>
                                    ...
                                    <option {{ $respondent_master->religion == 'Others' ? 'selected' : '' }} value="Others">
                                        Others</option>
                                </select>
                            </div>
                        </div>
